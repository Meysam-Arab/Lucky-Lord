...
return [
    ...
    */
    ...
    'min'                  => [
        'numeric' => 'یک :attribute رو لطفا انتخاب کن',
    ...
    */
    ...
    'attributes' => [
        ...
        "answer3"=>"گزینه سوم",
        "answer4"=>"گزینه چهارم",
        "result"=>"یک گزینه رو هم باید به عنوان جواب انتخاب کنی",
        "fileLogo"=>"یه تصویر برای این سوال",
        "answer"=>"جواب سوال تشریحی",
        "identifyCode"=>"کد شناسایی شما",
        "category"=>"دسته بندی",
    ],
