...
/**
 * Created by Meysam on 03/09/2017.
 */

public class LuckyLordThreadUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {

    private Context mContext;

    public LuckyLordThreadUncaughtExceptionHandler(Context cntx)
    {
        this.mContext = cntx;
    }
